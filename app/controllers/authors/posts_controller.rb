  ...
  class PostsController < AuthorController
    ...
    def create
      ...
      respond_to do |format|
        if @post.save
          format.html { redirect_to new_authors_post_path(@post), notice: 'Post was successfully created.' }
    ...
    private
      ...
      def post_params
        params.require(:post).permit(:catagory, :title, :description, :comments, :keyword, :numphoto, :tag_list, images: [])
      end
  end
